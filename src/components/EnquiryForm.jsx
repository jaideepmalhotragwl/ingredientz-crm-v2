...
function ProductAutocomplete({ value, onChange, onSelect, placeholder="e.g. Ashwagandha Extract KSM-66" }) {
  ...
  const inp = { background: C.white, border: `1px solid ${C.border}`, borderRadius: 7, padding: "7px 32px 7px 10px", color: C.ink, fontFamily: "Arial,sans-serif", fontSize: 13, outline: "none", width: "100%" };
