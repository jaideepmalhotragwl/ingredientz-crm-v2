...
import { previewInvoice } from "../../lib/docGen.js";
/**
...
export function InvoiceForm({ order, invoiceType, supplierPOs, orderItems, customer, onClose, onSave }) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // App.addInvoice handles PDF generation + attach when autoPdf is set.
      const opts = { autoPdf: isCustomer && autoPdf && !file, proforma };
      const result = await onSave(invoiceRow, file, opts);
